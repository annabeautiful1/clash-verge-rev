...
请到发布页面下载对应的安装包：[Release page](https://xfx88.top)<br>
Go to the [Release page](https://xfx88.top) to download the corresponding installation package<br>
...
| 版本        | 特征                                     | 链接                                                                                   |
| :---------- | :--------------------------------------- | :------------------------------------------------------------------------------------- |
| Stable      | 正式版，高可靠性，适合日常使用。         | [Release](https://xfx88.top)                 |
| Alpha(废弃) | 测试发布流程。                           | [Alpha](https://xfx88.top)         |
| AutoBuild   | 滚动更新版，适合测试反馈，可能存在缺陷。 | [AutoBuild](https://xfx88.top) |
